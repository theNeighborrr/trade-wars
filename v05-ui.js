import {STARTING_CASH,MAX_DAYS,assets,hubs,palette} from './v05-data.js?cache=15';
import {getState,getAsset,currentHub,hubFactor,localPrice,holdingsValue,netWorth,investedCost,unrealized,money,pct,signedMoney,trade,advanceDay,travelTo,resetState,localMove,exactMoney,previewTrade} from './v05-engine.js?cache=15';

import {initDesk,renderDesk,deskState,saveUI,showReceipt,openAssetHistory,offerCloseCampaign,offerNewRun,openResults} from './v05-desk.js?cache=15';
...
function renderHubs(){
  ...
  hubs.forEach(hub=>{
    ...
    btn.disabled=here||s.finished||s.day>=30||s.cash<hub.travelCost;
    ...
    if(sheetList){
      ...
      option.disabled=here||s.finished||s.day>=30||s.cash<hub.travelCost;
